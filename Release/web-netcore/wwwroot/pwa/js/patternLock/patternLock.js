...
;(function () {
    ...
    var startHandler = function (e, obj) {
        ...
        //assign events
        $(this).unbind("touchmove" + '.pattern-move').on("touchmove" + '.pattern-move', function (e) {
            moveHandler.call(this, e, obj);
        });
        $(this).unbind("mousemove" + '.pattern-move').on("mousemove" + '.pattern-move', function (e) {
            moveHandler.call(this, e, obj);
        });
       
        $(document).unbind("touchend").one("touchend", function () {
        	var dt2=new Date();
        	if (dt2.getTime() - dt.getTime() < 300)
        		return;
        	dt=dt2;
        	if(!patternLockflag)
        		return;
        	patternLockflag=false;
            endHandler.call(this, e, obj);
        });
        $(document).unbind("mouseup").one("mouseup", function () {
        	var dt2=new Date();
        	if (dt2.getTime() - dt.getTime() < 300)
        		return;
        	dt=dt2;
    ...
    function PatternLock(selector, option) {
        ...
        //assign event
        holder.unbind('touchstart').on("touchstart", function (e) {
            startHandler.call(this, e, self);
            patternLockflag=true;
        });
        holder.unbind('mousedown').on("mousedown", function (e) {
            startHandler.call(this, e, self);
            patternLockflag=true;
        });
        //handeling callback
